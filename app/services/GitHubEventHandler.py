...
class GitHubEventHandler:
    ...
    async def handle_pull_request_event(self, request: Request):
        ...
        pull_request_login = request_body["sender"]["login"]
        pull_request_login_url = request_body["sender"]["html_url"]
        pull_request_url = request_body["pull_request"]["html_url"]
        message = f"Pull Request [{pull_request_number}]({pull_request_url}) {pull_request_action} by [{pull_request_login}]({pull_request_login_url}). \
